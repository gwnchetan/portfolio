// ============================================================
        ...
        function bindCursorHovers() {
            // Make navigation and interactive elements magnetic
            Shery.makeMagnet(".nav-logo, .nav-right a, .mode-toggle, .hero-scroll", {
                ease: "cubic-bezier(0.23, 1, 0.320, 1)",
                duration: 1,
            });
        }
        ...
        const marqueeIconsList = [
            ...
            'ph-database', 'ph-globe', 'ph-lock-key', 'ph-server', 'ph-share-network'
        ];
